...
with Executor(endpoint_id=perlmutter_endpoint, funcx_client=gcc) as gce:
    ...
    for iteration in range(NUM_ITERATIONS):
        ...
        for i in range(NUM_FUNCTIONS):
            ...
            run_directory = f"/pscratch/sd/d/duccio/ionorb/batch_shot_163303/{str(i).zfill(4)}"
            shell_command = '/pscratch/sd/d/duccio/ionorb/ionorb_stl_boris2d ionorb_stl2d_boris.config'
            # run_dir = '/pscratch/sd/d/duccio/ionorb/batch_shot_163303/0000'
            stdout_file = "/pscratch/sd/d/duccio/ionorb/result_shell.txt"
            bf = ShellFunction(shell_command, run_dir=run_directory, stdout=stdout_file)
